              ...
              <div class="navbar-top">
                <div class="d-flex justify-content-between align-items-center">
                  <ul class="navbar-top-left-menu">
                     <li class="nav-item">
                      <a href="pages/index-inner.html" class="nav-link">Creating a Retake Free Environment For all Students</a>
                    </li>
                    ...
                    >
                      ...
                      >
                        ...
                        <li class="nav-item active">
                          <a class="nav-link" href="{{route('home')}}" style="text-transform: capitalize;">Home</a>
                        </li>
                        
                        <li class="nav-item">
                          <a class="nav-link" href="#" style="text-transform: capitalize;">About us</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="pages/sports.html" style="text-transform: capitalize;">Contact us</a>
                        </li>
              ...
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="position-relative">
                  ...
                  <div class="banner-content">
                    ...
                    <h1 class="mb-0" style="text-transform: uppercase">Welcome to Student Question Bank</h1>
                    <h2 class="mb-2">
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <div class="rotate-img">
                        <img
                          src="assets/images/financial.jpg"
                          alt="thumb"
        ...
        <footer>
          <div class="footer-top">
            <div class="container">
              <div class="row">
                <div class="col-sm-5">
                  <img src="assets/images/f1.png" height="60px" width="60px" class="footer-logo" alt="" /> Students Question Bank
                ...
                <div class="col-sm-12">
                  <div class="d-sm-flex justify-content-between align-items-center">
                    <div class="fs-14 font-weight-600">
                      © 2023 @ <a href="#" target="_blank" class="text-white"> Students Question Bank</a>. All rights reserved.
                    </div>
                    <div class="fs-14 font-weight-600">
                      Handcrafted by <a href="#" target="_blank" class="text-white">Group 72</a>
                    </div>
                  </div>
                </div>
              </div>
